...
knitr::opts_chunk$set(
    collapse = TRUE,
    comment = "#>",
    root.dir = "/gpfshpc/data/pmrdcdb/WORKSPACE_VBELCASTRO/gtox_usecase"
)
```
...
# Load data
mdat = read.csv("S167360_Lung_HCS_raw_metadata.csv")
mydat = read.csv("S167360_Lung_HCS_raw_data.csv")
